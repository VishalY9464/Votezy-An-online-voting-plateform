...
import com.vote.exception.ElectionAlreadyDeclaredException;
...
public class VoteService {
	...
	public Vote castVote(Long voterId, Long candidateId ) {
	    if (electionRepo.count() == 1) { // Ideally, check a proper flag like election.isDeclared()
	        throw new ElectionAlreadyDeclaredException("Election result already declared. Voting is closed.");
	    }
